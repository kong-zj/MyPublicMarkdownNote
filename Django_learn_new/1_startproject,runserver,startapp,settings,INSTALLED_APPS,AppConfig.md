...
![](resources/2024-01-16-22-31-58.png)
...
传统的 MVC 模式中，Model 和 View 之间是**直接交互**的，而 Django 中的 MTV 模式中，Model 和 View 之间是**通过 Template 进行交互**的

这里其实也是有 Controller（控制器）的，就是路由（负责URL的分发），负责将一个个URL的页面请求分发给不同的 View 来处理
