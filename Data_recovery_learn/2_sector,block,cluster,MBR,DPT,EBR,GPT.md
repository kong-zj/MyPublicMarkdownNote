...
**(最后一个扇区) - (占的总扇区数) = (最前一个扇区)**
这样我们可以依次推出6个NTFS文件系统如下：
1. 12591103 - 2097151 = 10493952
2. 10491903 - 2097151 = 8394752
3. 8392703 - 2097151 = 6295552
4. 6293503 - 2097151 = 4196352
5. 4196351 - 2097151 = 2099200
6. 2099199 - 2097151 （2,097,152）= 2048
...
- 扇区数量：2097151 （2,097,152）
- 类型: 07

第二个表项:
- 起始扇区地址：8392704 - 6293504 = 2099200
- 扇区数量：10491903 - 8392704 = 2099199（2,099,200）
- 类型: 05
